...
import { getUserDetailsById } from '../../featured/actions/userActions';
import { getAllMessages, sendMessage } from '../../featured/actions/messageActions';
// import { userDetailsReset } from '../../featured/reducers/user/userDetailsReducer';
import { allMessagesAdd, clearErrors } from '../../featured/reducers/message/allMessagesReducer';
import { newMessageReset } from '../../featured/reducers/message/newMessagereducer';
...
const Inbox = () => {
    ...
    useEffect(() => {
        arrivalMessage && arrivalMessage.sender === userId &&
            dispatch(allMessagesAdd(arrivalMessage));
    ...
    }, [dispatch, params.chatId, userId]);

    useEffect(() => {
        if (success) {
            dispatch(allMessagesAdd(newMessage))
    ...
    }, [dispatch, error, success, newMessage])
